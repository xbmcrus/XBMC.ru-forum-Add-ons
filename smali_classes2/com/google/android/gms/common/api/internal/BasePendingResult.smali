...
.field private volatile k:Ljfc;

.field private mResultGuardian:Ljeh;
...
.method constructor <init>()V
    ...
    invoke-direct {v0, v1}, Ljeg;-><init>(Landroid/os/Looper;)V
...
.method protected constructor <init>(Ljdh;)V
    ...
    iget-object v0, v0, Ljde;->g:Landroid/os/Looper;
    ...
    invoke-direct {v1, v0}, Ljeg;-><init>(Landroid/os/Looper;)V
...
.method public static h(Ljdq;)V
    .locals 3

    instance-of v0, p0, Ljdo;
...
# virtual methods
.method protected abstract a(Lcom/google/android/gms/common/api/Status;)Ljdq;
.end method
...
.method public final g(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->a(Lcom/google/android/gms/common/api/Status;)Ljdq;
...
.method public final i(Ljdq;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->d:Ljdq;

    invoke-interface {p1}, Ljdq;->a()Lcom/google/android/gms/common/api/Status;
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->d:Ljdq;

    instance-of p1, p1, Ljdo;

    if-eqz p1, :cond_0

    new-instance p1, Ljeh;

    invoke-direct {p1, p0}, Ljeh;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;)V

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->mResultGuardian:Ljeh;
    ...
    invoke-interface {v3, v4}, Ljdk;->a(Lcom/google/android/gms/common/api/Status;)V
    ...
    :cond_2
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h(Ljdq;)V
...
.method public final k(Ljdk;)V
    ...
    invoke-interface {p1, v1}, Ljdk;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final l(Ljava/util/concurrent/TimeUnit;)Ljdq;
    ...
    invoke-static {v0, v2}, Ljhp;->Y(ZLjava/lang/Object;)V

    const-string v0, "Cannot await if then() has been called."

    invoke-static {v1, v0}, Ljhp;->Y(ZLjava/lang/Object;)V
    ...
    invoke-static {p1, v0}, Ljhp;->Y(ZLjava/lang/Object;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->d:Ljdq;

    const/4 v2, 0x0

    iput-object v2, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->d:Ljdq;
