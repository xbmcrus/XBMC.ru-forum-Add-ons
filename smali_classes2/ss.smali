...
.method public static f(Landroid/app/Activity;)Landroid/content/Intent;
    ...
    invoke-static {p0}, Laax;->a(Landroid/app/Activity;)Landroid/content/Intent;

    move-result-object v0

    if-nez v0, :cond_2

    invoke-static {p0}, Lss;->h(Landroid/app/Activity;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p0, v2}, Lss;->i(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
...
.method public static g(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Intent;
    ...
    invoke-static {p0, p1}, Lss;->i(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lss;->i(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
...
.method public static h(Landroid/app/Activity;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lss;->i(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
