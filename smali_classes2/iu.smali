...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Liu;->c:Landroid/widget/ProgressBar;
...
.method final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Ladb;->a()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_8

    invoke-virtual {p0, v1, p2}, Liu;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    invoke-interface {v0}, Ladb;->b()V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Liu;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Liu;->a:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v0, p0, Liu;->a:Landroid/graphics/Bitmap;
...
.method public b(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Liu;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Liu;->b:[I
    ...
    iget-object v1, p0, Liu;->c:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p0, v7, v0}, Liu;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, v2}, Liu;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
