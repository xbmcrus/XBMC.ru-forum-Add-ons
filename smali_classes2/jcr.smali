...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljcr;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Ljcr;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)I
    ...
    sget-object v0, Ljcr;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    sget-object v0, Ljhb;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_1
    sget-boolean v2, Ljhb;->b:Z
    ...
    :try_start_2
    invoke-virtual {v3, v2, v4}, Lkgd;->m(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_5
    :goto_3
    invoke-static {p0}, Ljhy;->c(Landroid/content/Context;)Z
    ...
    sget-object v0, Ljhy;->a:Ljava/lang/Boolean;
    ...
    sput-object v0, Ljhy;->a:Ljava/lang/Boolean;
    ...
    invoke-static {v7, v1}, Ljcs;->c(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v6, v1}, Ljcs;->c(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Ljji;->g(I)I

    move-result p0

    invoke-static {p1}, Ljji;->g(I)I
...
.method public static b(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v3, v4}, Lkgd;->n(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v0, v1}, Ljcs;->c(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Ljcs;->c(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Ljcr;->d:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Ljcr;->d:Z
    :try_end_0
...
.method public static c(Landroid/content/Context;I)Z
    ...
    invoke-static {p0}, Ljcr;->d(Landroid/content/Context;)Z
