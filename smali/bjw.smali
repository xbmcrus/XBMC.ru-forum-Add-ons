...
.method public constructor <init>(Lbgj;Lbjt;)V
    ...
    iput-object p1, p0, Lbjw;->h:Landroid/graphics/RectF;

    new-instance p1, Lbgu;

    invoke-direct {p1}, Lbgu;-><init>()V

    iput-object p1, p0, Lbjw;->i:Landroid/graphics/Paint;

    const/16 v0, 0x8

    new-array v0, v0, [F

    iput-object v0, p0, Lbjw;->j:[F

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lbjw;->k:Landroid/graphics/Path;

    iput-object p2, p0, Lbjw;->l:Lbjt;
...
.method public final b(Landroid/graphics/RectF;Landroid/graphics/Matrix;Z)V
    ...
    iget-object p2, p0, Lbjw;->h:Landroid/graphics/RectF;

    iget-object p3, p0, Lbjw;->l:Lbjt;
    ...
    iget-object p2, p0, Lbjw;->a:Landroid/graphics/Matrix;

    iget-object p3, p0, Lbjw;->h:Landroid/graphics/RectF;
...
.method public final i(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
    ...
    :cond_0
    iget-object v1, p0, Lbjw;->g:Lbif;

    iget-object v1, v1, Lbif;->e:Lbhs;
    ...
    iget-object v2, p0, Lbjw;->i:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lbjw;->m:Lbhs;

    if-eqz v0, :cond_2

    iget-object v1, p0, Lbjw;->i:Landroid/graphics/Paint;
    ...
    iget-object p2, p0, Lbjw;->k:Landroid/graphics/Path;
    ...
    iget-object p3, p0, Lbjw;->i:Landroid/graphics/Paint;
